...
<div class="col-md-12 text-center" id="topo"  style=" height:1700px">
     <div class="container">
             <!---------------->
        <div class="container">
	    <div class="col-12">
		...
		<!--------conteudo--------------------------------->
			<div class="col-xs-12 col-8 col-sm-12 col-md-8">
                 <div class="nov4">
                    ...
                    <span>Projeto feito para fins de Estudo. Feito no Curso Técnico em informatica - Senac 2018</span>
                    <br><br><br>
                </div>
				<div class="card1">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-5">
                                <a href="#">
							<img class="card-img-top" src="assets/img/calixto.jpg" alt="Card image cap" style="border-radius: 10px;">
                                </a>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-7">
							<div class="card-body">
                            <h1 class="card-title">Gabriel Calixto</h1>
                            <a href="https://www.linkedin.com/in/gabriel-de-souza-calixto/">linkedin</a>
                            </div>
						</div>
					</div>
				</div>
				...
				<div class="card2">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-5">
                                <a href="#">
							<img class="card-img-top" src="assets/img/luiz.jpg" alt="Card image cap" style="border-radius: 10px;">
                                </a>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-7">
							<div class="card-body">
                            <h1 class="card-title">Luiz Gustavo</h1>
                            <a href="https://www.linkedin.com/in/luiz-gustavo-guaycurus-goulart-92498618a/">linkedin</a>
                            </div>
						</div>
					</div>
				</div>
				...
				<div class="card3">
					<div class="row">
						<div class="col-xs-4 col-sm-12 col-md-5">
                            <div class="over">
                                <a href="#">
							<img class="card-img-top" src="assets/img/samuel.jpg" alt="Card image cap" style="border-radius: 10px;">
                                </a>
                            </div>
						</div>
						<div class="col-xs-4 col-sm-12 col-md-7">
							<div class="card-body">
                                <h1 class="card-title">Samuel Diogo</h1>
                                <a href="https://www.linkedin.com/in/samuel-diogo-769274195/">linkedin</a>
                            </div>
						</div>
					</div>
				</div>
                ...
                <div class="card3">
					<div class="row">
						<div class="col-xs-4 col-sm-12 col-md-5">
                            <div class="over">
                                <a href="#">
							<img class="card-img-top" src="assets/img/edison.jpg" alt="Card image cap" style="border-radius: 10px;">
                                </a>
                            </div>
						</div>
						<div class="col-xs-4 col-sm-12 col-md-7">
							<div class="card-body">
                                <h1 class="card-title">Edison Junior</a></h1>
                                <a href="https://www.linkedin.com/in/edison-junior/">linkedin</a>
                            </div>
						</div>
					</div>
				</div>
